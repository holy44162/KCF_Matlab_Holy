function [img_files, pos, target_sz, ground_truth, video_path] = load_video_info_holy(base_path, video)
%LOAD_VIDEO_INFO
...
%   http://www.isr.uc.pt/~henriques/
	...
	filename = [video_path 'positionMaxCV' suffix '.txt'];
	f = fopen(filename);
	...
	if isempty(idx),
		...
		elseif exist(sprintf('%s%05i.jpg', video_path, frames{idx,2}), 'file'),
